...
const CourseDetails = () => {
  ...
  return (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-28 px-8 md:pt-30 pt-20 text-left">
        <div className='absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b from-blue-300/70'>{/* left column */}
                          ...
                          <li key={i} className='flex items-start gap-2 py-1'>
                            ...
                            <div className='flex items-center justify-between w-full text-gray-800 text-xs md:text-default'>
                              ...
                              <div className='flex gap-2 '>
                                {lec.isPreviewFree && <p onClick={() => setPlayerData({
        ...
        <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>{/* right column */}
          ...
          <div className='p-5'>
            <div className='flex items-center gap-2'>
              ...
              <img src={assets.time_left_clock_icon} alt="time_left" className='w-3.5' />
