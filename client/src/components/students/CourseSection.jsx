...
const CourseSection = () => {
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
      ...
      <p className='text-gray-500 text-sm md:text-base mt-2'>Discover our Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt harum, facilis adipisci esse nisi dignissimos architecto at quam, reiciendis molestias repudiandae inventore, voluptates ipsam! Rerum assumenda aliquid ipsa ipsam vel!</p>
